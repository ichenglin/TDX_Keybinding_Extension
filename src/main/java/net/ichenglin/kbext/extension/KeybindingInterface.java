...
public class KeybindingInterface {
    ...
    private void advanced_initialize() {
        // layout
        ...
        // instant upgrade
        JKeybindingButton instantupgrade_top_button    = new JKeybindingButton('F');
        JKeybindingButton instantupgrade_bottom_button = new JKeybindingButton('T');
